...
urlpatterns = [
    ...
    path('email-hash/', include('email_hash.urls')),
    # path('tmp-user/', include('tmpuser.urls')),
    path('tmp-user/start-new-project/',
         user_views.start_new_project, name='start_new_project'),
