...
def Whole_check_denovo_based_results(url_base_dir, base_dir, sample_list):
    ...
    for sample_name in sample_list:
        ...
        # print("Step_4_check_denovo_samtools_sorted_bam: ", Step_4_check_denovo_samtools_sorted_bam[0])
        # print("Step_5_check_denovo_bcftools_vcf: ", Step_5_check_denovo_bcftools_vcf[0])
        # print("Step_5_check_denovo_bcftools_vcf_revise: ", Step_5_check_denovo_bcftools_vcf_revise[0])
        # print("Step_6_check_denovo_snpeff_vcf_annotation: ", Step_6_check_denovo_snpeff_vcf_annotation[0])
